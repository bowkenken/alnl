...
* へ手紙を書いてください。
* 
* $Id: menu-town.c,v 1.169 2014/01/07 23:40:42 bowkenken Exp $
***************************************************************/
...
#include	"menu-town-tab.h"

/**/

static mbr_t	*g_sel_mbr, *g_sel_ls_mbr;
check_memory_def( check_memory_menu_town_c_g_sel_mbr )

static shop_n_t	g_shop_n;
static deal_kind_t	g_deal_kind;
static item_t	*g_sel_art;
static long	g_sel_class_n;
check_memory_def( check_memory_menu_town_c_g_shop_n )

static item_t	*g_mbr_order[MBR_MAX_N];
check_memory_def( check_memory_menu_town_c_g_mbr_order )

static menu_t	*g_navi_dflt;
check_memory_def( check_memory_menu_town_c_g_navi_dflt )

/**/

static edit_class_t	static_exec_edit_class__n;
static edit_skill_t	static_exec_edit_skill__n;
check_memory_def( check_memory_menu_town_c_static_exec_edit_class__n )

skill_kind_t	g_sel_skill_kind;
edit_skill_t	g_skill_slot_n;
check_memory_def( check_memory_menu_town_c_g_sel_skill_kind  )
...
void	check_memory_menu_town_c( void )
{
	check_memory( check_memory_menu_town_c_g_sel_mbr,
			"menu_town.c: g_sel_mbr" );
	check_memory( check_memory_menu_town_c_g_shop_n,
			"menu_town.c: g_shop_n" );
	check_memory( check_memory_menu_town_c_g_mbr_order,
			"menu_town.c: g_mbr_order" );
	check_memory( check_memory_menu_town_c_g_navi_dflt,
			"menu_town.c: g_navi_dflt" );
	check_memory( check_memory_menu_town_c_static_exec_edit_class__n,
			"menu_town.c: static_exec_edit_class__n" );
	check_memory( check_memory_menu_town_c_g_sel_skill_kind,
			"menu_town.c: g_sel_skill_kind" );
}
