...
* へ手紙を書いてください。
* 
* $Id: menu-main.c,v 1.66 2014/01/07 23:40:42 bowkenken Exp $
***************************************************************/
...
check_memory_def( check_memory_menu_main_c_g_main_crsr )

static menu_t	*g_menu_dflt_main;
check_memory_def( check_memory_menu_main_c_g_menu_dflt_main )
...
check_memory_def( check_memory_menu_main_c_g_sub_sel_mbr )

static bool_t	g_flg_no_save;
static long	g_sel_save_load_n;
check_memory_def( check_memory_menu_main_c_g_flg_no_save )
...
check_memory_def( check_memory_menu_main_c_ls_equip_msg )

/**/

#include	"menu-main-tab.h"

/**/

static long static_cb_menu_item__pre_sel_mbr_n;
check_memory_def( check_memory_menu_main_c_pre_sel_mbr_n )
...
void	check_memory_menu_main_c( void )
{
	check_memory( check_memory_menu_main_c_g_main_crsr,
			"menu_main.c: g_main_crsr" );
	check_memory( check_memory_menu_main_c_g_menu_dflt_main,
			"menu_main.c: g_menu_dflt_main" );
	check_memory( check_memory_menu_main_c_g_sub_sel_mbr,
			"menu_main.c: g_sub_sel_mbr" );
	check_memory( check_memory_menu_main_c_g_flg_no_save,
			"menu_main.c: g_flg_no_save" );
	check_memory( check_memory_menu_main_c_g_sel_obj_trgt_kind,
			"menu_main.c: g_sel_obj_trgt_kind" );
	check_memory( check_memory_menu_main_c_g_sel_mbr_n,
			"menu_main.c: g_sel_mbr_n" );
	check_memory( check_memory_menu_main_c_g_mark_sel_mbr,
			"menu_main.c: g_mark_sel_mbr" );
	check_memory( check_memory_menu_main_c_ls_equip_msg,
			"menu_main.c: ls_equip_msg" );
	check_memory( check_memory_menu_main_c_pre_sel_mbr_n,
			"menu_main.c: pre_sel_mbr_n" );
}
