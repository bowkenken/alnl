...
* へ手紙を書いてください。
* 
* $Id: menu-amark.c,v 1.121 2014/03/01 23:48:01 bowkenken Exp $
***************************************************************/
...
check_memory_def( check_memory_menu_amark_c_ls_auto_mark )
static bool_t	ls_flg_ena_auto_mark[AUTO_MARK_MAX_N];
check_memory_def( check_memory_menu_amark_c_ls_flg_ena_auto_mark )

static auto_mark_t	clip_board_large[LS_MBR_MAX_N][POSITION_KIND_MAX_N];
check_memory_def( check_memory_menu_amark_c_clip_board_large )
static auto_mark_t	clip_board_small;
check_memory_def( check_memory_menu_amark_c_clip_board_small )

static auto_mark_appoint_item_t	clip_board_large_item
		[LS_MBR_MAX_N][AUTO_MARK_APPOINT_ITEM_MAX_N];
check_memory_def( check_memory_menu_amark_c_clip_board_large_item )
static auto_mark_appoint_item_t	clip_board_small_item
		[AUTO_MARK_APPOINT_ITEM_MAX_N];
check_memory_def( check_memory_menu_amark_c_clip_board_small_item )

static char	msg_ttl_auto_mark[AUTO_MARK_MAX_N]
		[MSG_TTL_AUTO_MARK_MAX_BYTE + 1];
check_memory_def( check_memory_menu_amark_c_msg_ttl_auto_mark )
static char	clip_board_ttl
		[MSG_TTL_AUTO_MARK_MAX_BYTE + 1];
check_memory_def( check_memory_menu_amark_c_clip_board_ttl )

static long	auto_mark_cur_n;
static mbr_t	*g_sel_mbr;
check_memory_def( check_memory_menu_amark_c_auto_mark_cur_n )
...
check_memory_def( check_memory_menu_amark_c_dflt_auto_mark_fight )

static auto_mark_appoint_item_t	auto_mark_appoint_item
		[LS_MBR_MAX_N][AUTO_MARK_MAX_N]
		[AUTO_MARK_APPOINT_ITEM_MAX_N];
check_memory_def( check_memory_menu_amark_c_auto_mark_appoint_item )
...
check_memory_def( check_memory_menu_amark_c_auto_mark_appoint_item_dflt )

/***************************************************************/

#include	"menu-amark-tab.h"
...
void	check_memory_menu_amark_c( void )
{
	check_memory( check_memory_menu_amark_c_ls_auto_mark,
			"menu_amark.c: ls_auto_mark" );
	check_memory( check_memory_menu_amark_c_ls_flg_ena_auto_mark,
			"menu_amark.c: ls_flg_ena_auto_mark" );
	check_memory( check_memory_menu_amark_c_clip_board_large,
			"menu_amark.c: clip_board_large" );
	check_memory( check_memory_menu_amark_c_clip_board_small,
			"menu_amark.c: clip_board_small" );
	check_memory( check_memory_menu_amark_c_clip_board_large_item,
			"menu_amark.c: clip_board_large_item" );
	check_memory( check_memory_menu_amark_c_clip_board_small_item,
			"menu_amark.c: clip_board_small_item" );
	check_memory( check_memory_menu_amark_c_msg_ttl_auto_mark,
			"menu_amark.c: msg_ttl_auto_mark" );
	check_memory( check_memory_menu_amark_c_clip_board_ttl,
			"menu_amark.c: clip_board_ttl" );
	check_memory( check_memory_menu_amark_c_auto_mark_cur_n,
			"menu_amark.c: auto_mark_cur_n" );
	check_memory( check_memory_menu_amark_c_dflt_auto_mark_fight,
			"menu_amark.c: dflt_auto_mark_fight" );
	check_memory( check_memory_menu_amark_c_auto_mark_appoint_item,
			"menu_amark.c: auto_mark_appoint_item" );
	check_memory( check_memory_menu_amark_c_auto_mark_appoint_item_dflt,
			"menu_amark.c: auto_mark_appoint_item_dflt" );
}
