...
* へ手紙を書いてください。
* 
* $Id: menu-misc.c,v 1.146 2014/01/07 23:40:42 bowkenken Exp $
***************************************************************/
...
check_memory_def( check_memory_menu_misc_c_g_menu_dflt_misc )

static mbr_t	*g_sel_mbr;
check_memory_def( check_memory_menu_misc_c_g_sel_mbr )

static bool_t	g_flg_continue_exec_mode;
check_memory_def( check_memory_menu_misc_c_g_flg_continue_exec_mode )
static bool_t	g_ls_flg_srch[LS_MBR_MAX_N];
check_memory_def( check_memory_menu_misc_c_g_ls_flg_srch )

static menu_t	ls_menu_ind_square[1 + 1 + (1 + MBR_MAX_N + 1) + 1];
check_memory_def( check_memory_menu_misc_c_ls_menu_ind_square )
static menu_t	*g_menu_dflt_ind_square;
check_memory_def( check_memory_menu_misc_c_g_menu_dflt_ind_square )

static flg_scroll_t	g_flg_scroll;
static next_pos_t	g_next_pos;
static curs_attr_t	*g_sel_attr;
check_memory_def( check_memory_menu_misc_c_g_flg_scroll )

static long	g_cui_mouse_double_click_msec;
check_memory_def( check_memory_menu_misc_c_g_cui_mouse_double_click_msec )

static rate_t	g_music_volume_rate;
static rate_t	g_sound_volume_rate;
static bool_t	g_flg_mute_audio;
check_memory_def( check_memory_menu_misc_c_g_music_volume_rate )

#define	JOYSTICK_SEL_N_MAX_N	10
static menu_t	ls_menu_joystick_sel_n[JOYSTICK_SEL_N_MAX_N * 2];
check_memory_def( check_memory_menu_misc_c_ls_menu_joystick_sel_n )

#define	USER_MENU_MAX_N_PER_PAGE	(MENU_MAX_N_PER_PAGE - 3)
static long	g_user_menu_n;
check_memory_def( check_memory_menu_misc_c_g_user_menu_n )
static char	g_user_menu_name[USER_MENU_MAX_N][MENU_MSG_MAX_BYTE + 1];
check_memory_def( check_memory_menu_misc_c_g_user_menu_cmd )

static long	g_replay_sel_load_n;
check_memory_def( check_memory_menu_misc_c_g_user_menu_name )
static char	g_user_menu_cmd[USER_MENU_MAX_N][MACRO_MAX_LEN + 1];
check_memory_def( check_memory_menu_misc_c_g_replay_sel_load_n )
static menu_t	ls_menu_replay_sel_load[MENU_SAVE_LOAD_MAX_N * 2];
check_memory_def( check_memory_menu_misc_c_ls_menu_replay_sel_load )

static long	*g_page_n;
static data_n_t	*g_data_n;
static mbr_data_edit_kind_t	g_mbr_data_edit_kind;
check_memory_def( check_memory_menu_misc_c_g_page_n )
...
check_memory_def( check_memory_menu_misc_c_g_flg_mbr_data_change_page_ )

/**/

#include	"menu-misc-tab.h"
...
check_memory_def( check_memory_menu_misc_c_n )
...
{
	check_memory( check_memory_menu_misc_c_g_menu_dflt_misc,
			"menu_misc.c: g_menu_dflt_misc" );
	check_memory( check_memory_menu_misc_c_g_sel_mbr,
			"menu_misc.c: g_sel_mbr" );
	check_memory( check_memory_menu_misc_c_g_flg_continue_exec_mode,
			"menu_misc.c: g_flg_continue_exec_mode" );
	check_memory( check_memory_menu_misc_c_g_ls_flg_srch,
			"menu_misc.c: g_ls_flg_srch" );
	check_memory( check_memory_menu_misc_c_ls_menu_ind_square,
			"menu_misc.c: ls_menu_ind_square" );
	check_memory( check_memory_menu_misc_c_g_menu_dflt_ind_square,
			"menu_misc.c: g_menu_dflt_ind_square" );
	check_memory( check_memory_menu_misc_c_g_flg_scroll,
			"menu_misc.c: g_flg_scroll" );
	check_memory( check_memory_menu_misc_c_g_cui_mouse_double_click_msec,
			"menu_misc.c: g_cui_mouse_double_click_msec" );
	check_memory( check_memory_menu_misc_c_g_music_volume_rate,
			"menu_misc.c: g_music_volume_rate" );
	check_memory( check_memory_menu_misc_c_ls_menu_joystick_sel_n,
			"menu_misc.c: ls_menu_joystick_sel_n" );
	check_memory( check_memory_menu_misc_c_g_user_menu_n,
			"menu_misc.c: g_user_menu_n" );
	check_memory( check_memory_menu_misc_c_g_user_menu_name,
			"menu_misc.c: g_user_menu_name" );
	check_memory( check_memory_menu_misc_c_g_user_menu_cmd,
			"menu_misc.c: g_user_menu_cmd" );
	check_memory( check_memory_menu_misc_c_g_replay_sel_load_n,
			"menu_misc.c: g_replay_sel_load_n" );
	check_memory( check_memory_menu_misc_c_ls_menu_replay_sel_load,
			"menu_misc.c: ls_menu_replay_sel_load" );
	check_memory( check_memory_menu_misc_c_g_page_n,
			"menu_misc.c: g_page_n" );
	check_memory( check_memory_menu_misc_c_g_flg_mbr_data_change_page_,
			"menu_misc.c: g_flg_mbr_data_change_page_is_crsr" );
	check_memory( check_memory_menu_misc_c_n,
			"menu_misc.c: n" );
}
