...
void DemoTitle::init()
{
	...
	std::string dir = STR_FIX_GRAPH_DIR_NAME;
...
# endif // D_GL
		...
		char buf[32];
		::sprintf( buf, "%ld", (long)(TITLE_FONT_POINT * 10) );
